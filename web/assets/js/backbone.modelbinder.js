// PATCHED BY Bogdan Yurov, _onModelChange
// ---------------------------------------
//
...
(function (factory) {
    ...
    _.extend(Backbone.ModelBinder.prototype, {
        ...
        _onModelChange:function (caller) {
            var changedAttribute, attributeBinding;

            var attr = caller === this ?
                this._model.changedAttributes():
                caller.mapChangedAttributes ? caller.mapChangedAttributes(this) :
                    this._model.changedAttributes() ;

            for (changedAttribute in attr) {
